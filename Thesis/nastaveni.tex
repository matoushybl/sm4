...
V rámci práce je popsán vývoj jak elektroniky, tak příslušného software.
Elektronika kontrolŕu je založena na mikrokontroléru STM32F405 a driverů krokových motorů vyráběných firmou Trinamic.
Pro komunikaci s nadřazenými systémy je implementován CANOpen a sběrnice I\textsuperscript{2}C a USB.
...
Sekundárním cílem této práce je ukázat, jak lze tento programovací jazyk s výhodou použít pro programování nízkoúrovňového vestavného software.
...
For communication with higher level systems, the controller utilizes CANOpen, I\textsuperscript{2}C and USB buses.
...
As for the software, both firmware and control software was developed.
...
Secondary goal of this thesis is to show how the language can be utilized for low-level embedded software development.
The firmware of the controller implements motion controller independently for each of the axis with both velocity and position control and provides some failsafe mechanisms for cases of communication failures.
