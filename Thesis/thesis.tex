...
%	language={C},           % jazyk C
	language={Rust},           % jazyk C
	morekeywords={let,mut,struct,pub,impl,use,assert\_eq,enum,match,if,fn,\&,self,f32,println!,str,i64,u8,u16,u32,u64,usize,trait,where,dyn,const,static},
	frame=single,
	captionpos=b,
	numbers=left,
	breaklines=true,
...
\input{text/extended_abstract.tex}
\makecitation
\makedeclaration
\makeacknowledgement
\tableofcontents
...
\input{text/steppers}
\input{text/comm_protocol}
\input{text/rust}
\input{text/embedded_rust}
\include{text/requirements}
\include{text/hardware}
\input{text/kicad_design}
\include{text/firmware}
\input{text/eeprom}
\input{text/control_software}
