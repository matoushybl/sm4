...
\label{subsec:nema}
In this Section, a typical NEMA17 is described.
NEMA17 describes the flange size, where the number denotes the flange size in tenths of an inch\cite{reprap_nema_nodate}, in this case 1.7".
