...
In Better Embedded System Software\cite{koopman_better_2010} the author specifies written requirements as one of the most important parts of documentation for any embedded system.
...
\begin{itemize}
    ...
    \item \textbf{C-02} The controller shall be able to drive motors with phase current of up to 2~A.
