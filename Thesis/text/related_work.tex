...
\begin{figure}[H]
    ...
    \caption{KM2 motor controller render~\cite{frantisek_burian_km2renderpng_nodate}.}
    \label{fig:km2render}
\end{figure}
...
The creators achieve that by mounting a PCB on the back of the motor that contains the power stage a MCU and a 14-bit magnetic encoder~\cite{tropical_labs_mechaduino_2021}.
...
\section{Flott}
\label{sec:flott}
Flott is a set of libraries suitable for developing motion controllers in the Rust programming language\cite{hanno_braun_flott_nodate}.
